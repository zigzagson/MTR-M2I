...
class MotionTransformer(nn.Module):
    ...
    def forward(self, batch_dict):
        ...
        # batch_dict['center_objects_feature']  [num_centered_objs,256]
        # batch_dict['obj_feature']             [num_centered_objs,num_objects,256]
        # batch_dict['map_feature']             [num_centered_objs,polylines,256]   
        # batch_dict['obj_mask']                [num_centered_objs,num_objects]
        # batch_dict['map_mask']                [num_centered_objs,polylines]
        # batch_dict['obj_pos']                 [num_centered_objs,num_objects,3]
        # batch_dict['map_pos']                 [num_centered_objs,polylines,3]
